      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/a.jpeg'), // Corrected here
            fit: BoxFit.cover, // Add this to fit the image to the container
          ),
        ),
        child: Column(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  icon: Icon(
                    isObscure ? Icons.visibility_off : Icons.visibility, // Toggle icon
                  ),
                ),
              ),
            ),
