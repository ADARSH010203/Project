                        ...
                        SizedBox(
                          ...
                          child: TextButton(
                            onPressed: () {
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (context)=>const Fluits())
                              );
                            },
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      image: const DecorationImage(image: AssetImage("assets/APX.jpg"),fit: BoxFit.cover),
                      boxShadow: const [
                        BoxShadow(
                          // color: Colors.black,
                          blurRadius: 10,
